...
А именно, что есть в проекте:
- реализован сайт в виде блога, с возможностью добавления статей;
- организована регистрация и авторизация пользователей, так же добавлен модуль-защиты captcha;
- сделана разбивка статей по категориям в сайд-баре и добалена пагинация при большом количества страниц;
- в процессе реализации отработана на практике теория после курсов по SQL-запросам в БД;
